  ...
  return (
    ...
    >
      ...
      <div className="network-content max-w-5xl mx-auto relative z-10 text-center flex flex-col items-center gap-6">
        <span className="text-[10px] sm:text-xs font-mono tracking-widest text-primary block uppercase">
          // YOU’RE UP
        </span>

        <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-black text-white uppercase leading-[1.08] max-w-3xl">
          THE MARKET’S HERE.<br className="hidden sm:inline" /> WHAT’S YOUR MOVE?
        </h2>

        <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-3 text-sm sm:text-base font-display font-bold text-primary uppercase mt-1">
          <span>MEMES.</span>
        ...
        <p className="text-white/70 font-body text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed mt-2">
          Pick your market. Pick your play. i5 keeps the rest within reach.
        </p>
