...
export function HeroSection({ triggerShake: _triggerShake }: HeroSectionProps) {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[92vh] flex flex-col justify-center px-6 sm:px-12 md:px-16 lg:px-20 pt-8 sm:pt-8 lg:pt-10 select-none pb-0 sm:pb-8 lg:pb-16">
