      ...
      {mobileMenuOpen && (
        <div className="mobile-menu-dropdown">
          <ul className="mobile-nav-links">
            ...
            <li><a href="#capabilities" onClick={handleLinkClick}>Features</a></li>
            <li><a href="#edge" onClick={handleLinkClick}>Compare</a></li>
            <li><a href="#users" onClick={handleLinkClick}>Users</a></li>
          </ul>
